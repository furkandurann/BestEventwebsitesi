export const organicCakes = [
  {
    ...
    features: [
      ...
      'Koruyucu Madde İçermez',
      'Glütensiz Seçeneği Mevcut',
      'Taze Meyvelerle Süsleme'
    ],
    category: 'Çikolata'
  },
  {
...
export const cakeCategories = [
  { id: 'all', name: 'Tümü' },
  { id: 'Çikolata', name: 'Çikolatalı' },
  { id: 'Meyveli', name: 'Meyveli' },
  { id: 'Vanilya', name: 'Vanilyalı' },
  { id: 'Özel', name: 'Özel Tarifler' },
  { id: 'Karamel', name: 'Karamelli' }
]
