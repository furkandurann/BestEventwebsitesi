// İstanbul Çocuk Etkinlikleri Ana Hub Verisi
// SEO-optimized, keyword density %1-2, duplicate content yok
...
export const istanbulEtkinlikHubData = {
  seo: {
    ...
    keywords: [
      ...
      "çocuk etkinliği kiralama",
      "sihirbaz gösterisi istanbul",
      "doğum günü organizasyonu istanbul"
    ],
    url: "https://bestevent.com.tr/blog/istanbul-etkinlik-rehberi",
    image: "/content/images/cocukdogumgunu/konseptdogumgunu.webp"
  },

  hero: {
    title: "İstanbul'da Çocuk Etkinlikleri",
    subtitle: "Organizasyon, Kiralama ve Gösteri Hizmetleri",
    description: "İstanbul'un her köşesinde profesyonel çocuk etkinliği hizmetleri. 10+ yıl deneyim, 5000+ mutlu çocuk."
  },

  giris: {
    baslik: "İstanbul'da Çocuk Etkinliği Dünyası",
    paragraflar: [
      "İstanbul'da bir çocuk etkinliği planlamak, şehrin dinamik yapısı ve geniş coğrafyası nedeniyle bazen zorlayıcı olabilir. Kadıköy'den Beylikdüzü'ne, Sarıyer'den Pendik'e uzanan bu büyük metropolde her semt kendine özgü bir karaktere sahip. Bazı semtler geniş park alanları sunarken, bazıları modern site yapılarıyla öne çıkar.",
      
      "10 yılı aşkın süredir İstanbul'un dört bir yanında çocuk etkinlikleri organize ediyoruz. Geçtiğimiz 10 yılda 5000'den fazla çocuğun yüzünde gülümseme oluşturduk. Her etkinliğin ardından ailelerden aldığımız geri bildirimler bizi motive ediyor ve hizmet kalitemizi sürekli geliştirmemizi sağlıyor.",
      
      "Bu rehberde İstanbul'daki çocuk etkinliği organizasyonu, palyaço ve sihirbaz kiralama, bubble show gösterisi gibi hizmetlerimizi detaylıca bulabilirsiniz. Hangi semtte olursanız olun, size en yakın profesyonel çözümler için yanınızdayız."
    ]
  },
  ...
  faq: [
    {
      soru: "İstanbul'da çocuk etkinliği organize etmek için ne kadar önceden rezervasyon yapmalıyım?",
      cevap: "Hafta sonları için en az 2-3 hafta önceden rezervasyon yapmanızı öneririz."
    }
  ],
