...
const GirlsMascots = () => {
  ...
  useEffect(() => {
    const handleKeyPress = (e) => {
      if (e.key === 'ArrowDown' && activeSection < girlsMascots.length - 1) {
  ...
  }, [activeSection, girlsMascots.length])
          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-6">
              {(() => {
                const faqs = [
                  {
                    question: "Hangi kız maskotları mevcut?",
                    answer: "Hello Kitty, Kuromi, Unicorn, Minnie Mouse, LOL Bebek, Sevimli Tavşan, Sevimli Kedi ve Kalp maskotlarımız mevcuttur."
                  },
                  {
                    question: "Kız çocuk maskot organizasyon kaç saat sürer?",
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Hangi kız maskotları mevcut?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Hello Kitty, Kuromi, Unicorn, Minnie Mouse, LOL Bebek, Sevimli Tavşan, Sevimli Kedi ve Kalp maskotlarımız mevcuttur."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Kız çocuk maskot organizasyon kaç saat sürer?",
                  "acceptedAnswer": {
                    "@type": "Answer",
        ...
        <section className="py-20 bg-gradient-to-br from-pink-600 via-rose-500 to-orange-500">
          <div className="max-w-4xl mx-auto px-4 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/905349306799?text=Kız çocuk maskot organizasyon hakkında bilgi almak istiyorum"
                target="_blank"
