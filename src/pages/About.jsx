  ...
  return (
    <main className="bg-black min-h-screen text-white">
      <Seo
        ...
        description="Best Event, 10 yılı aşkın deneyimiyle İstanbul ve Türkiye genelinde profesyonel etkinlik organizasyonu hizmeti sunan güvenilir firma. 1000+ başarılı organizasyon, kurumsal ve bireysel etkinlik çözümleri. Çocuk etkinlikleri, kurumsal organizasyonlar, müzik ve dans gösterileri. ☎ 05307309009"
        keywords={[
          "best event hakkında",
