...
export const districts = [
  {
    ...
    venueGuide: 'Kadıköy\'de etkinlik mekanı seçerken sahil bölgesi ve iç kesimler arasında tercih yapmanız gerekir. Caddebostan Sahili boyunca çim alanlar açık hava partileri için idealdir; Fenerbahçe Parkı geniş gruplar için otopark avantajı sunar. Kapalı mekan için Nautilus AVM ve Acıbadem\'deki butik etkinlik salonları popüler seçeneklerdir. Suadiye ve Erenköy\'deki villaların bahçeleri özel organizasyonlar için kiralanabilir. Göztepe Parkı\'nın çocuk oyun alanı yanındaki piknik bölgeleri küçük doğum günleri için ücretsiz alternatif sunar.',
    transportDetails: 'Kadıköy\'e Marmaray, M4 metro hattı, İDO vapurları ve çok sayıda otobüs hattıyla kolayca ulaşılır. Kadıköy-Kartal metro hattı Acıbadem, Ünalan ve Göztepe duraklarıyla ilçenin iç kesimlerine erişim sağlar. Sahil boyunca 10E, 17 ve KM22 otobüsleri düzenli sefer yapar. Caddebostan ve Suadiye bölgelerinde hafta sonu parklanma sıkıntısı yaşanabilir; toplu taşıma tercih edilmelidir.',
    localCulture: 'Kadıköy, İstanbul\'un en canlı kültür ve sanat merkezlerinden biridir. Moda sahilindeki açık hava konserleri, Caddebostan\'daki sokak festivalleri ve Yeldeğirmeni\'ndeki duvar sanatı etkinlikleri bölgenin dinamik kültürel yapısını yansıtır. Hafta sonları Kadıköy Çarşısı çevresindeki butik kafelerde çocuk atölyeleri düzenlenmektedir.',
    neighborhoodDetails: [
      { name: 'Moda', tip: 'Sahil yürüyüş yolu boyunca çim alanlar küçük partiler için ideal', bestVenue: 'Moda Parkı & Sahili' },
      { name: 'Caddebostan', tip: 'Geniş sahil parkı büyük gruplar için en uygun alan', bestVenue: 'Caddebostan Sahil Parkı' },
      { name: 'Fenerbahçe', tip: 'Otopark avantajlı geniş park alanı', bestVenue: 'Fenerbahçe Parkı' },
      { name: 'Acıbadem', tip: 'Kapalı mekan etkinlikleri için AVM ve salon seçenekleri', bestVenue: 'Acıbadem Etkinlik Salonları' },
      { name: 'Göztepe', tip: 'Çocuk oyun alanı ve piknik bölgesi birlikte', bestVenue: 'Göztepe Parkı' },
      { name: 'Erenköy', tip: 'Sakin sokakları ve bahçeli villaları ile özel organizasyonlar', bestVenue: 'Erenköy Villa Bahçeleri' }
    ]
  },
  {
    slug: 'besiktas',
    ...
    venueGuide: 'Beşiktaş\'ta etkinlik mekanı seçenekleri oldukça geniştir. Boğaz manzaralı organizasyonlar için Ortaköy ve Bebek sahilindeki restoranlar tercih edilir. Yıldız Parkı ve Maçka Parkı açık hava etkinlikleri için geniş alanlar sunar. Etiler ve Levent bölgelerindeki 5 yıldızlı oteller kurumsal çocuk etkinlikleri için profesyonel hizmet verir. Nişantaşı\'ndaki butik etkinlik mekanları küçük ve şık doğum günleri için idealdir. Akmerkez, Kanyon ve Zorlu Center gibi AVM\'ler kış aylarında kapalı mekan partileri için popüler seçeneklerdir.',
    transportDetails: 'Beşiktaş\'a deniz yoluyla Beşiktaş İskelesi, karayoluyla E-5 ve TEM bağlantılarıyla ulaşılır. M2 metro hattı Levent ve 4. Levent duraklarıyla bölgenin kuzeyini besler. Kabataş tramvay durağından Beşiktaş\'a yürüme mesafesindedir. Ortaköy ve Bebek bölgelerinde hafta sonu parklanma çok zordur; vale servisli mekanlar tercih edilmelidir.',
    localCulture: 'Beşiktaş, İstanbul\'un kültürel çeşitliliğinin en yoğun hissedildiği ilçesidir. Ortaköy Meydanı\'ndaki hafta sonu pazarları, Bebek sahilinde sabah koşuları yapan aileler ve Arnavutköy\'ün tarihi ahşap evleri bölgenin dinamik yapısını oluşturur. Boğaz kıyısındaki restoranlar çocuklar için özel menüler ve oyun alanları sunmaktadır.',
    neighborhoodDetails: [
      { name: 'Ortaköy', tip: 'Boğaz manzaralı mekanlar ve tarihi atmosfer', bestVenue: 'Ortaköy Sahil Restoranları' },
      { name: 'Bebek', tip: 'Lüks kafeler ve sahil yürüyüş yolu', bestVenue: 'Bebek Parkı & Sahili' },
      { name: 'Etiler', tip: '5 yıldızlı oteller ve kurumsal etkinlik alanları', bestVenue: 'Swissotel & DoubleTree' },
      { name: 'Levent', tip: 'AVM etkinlik alanları ve plaza salonları', bestVenue: 'Kanyon & Akmerkez' },
      { name: 'Nişantaşı', tip: 'Butik mekanlar ve şık doğum günü salonları', bestVenue: 'Nişantaşı Butik Salonlar' }
    ]
  },
  {
    slug: 'sisli',
    ...
    venueGuide: 'Şişli, İstanbul\'un merkezinde kapalı mekan etkinlikleri için en zengin seçenekleri sunar. Hilton İstanbul Bomonti ve Marriott Şişli gibi oteller profesyonel etkinlik organizasyonu altyapısına sahiptir. Cevahir AVM\'nin çocuk etkinlik alanı hafta sonu partileri için popülerdir. Bomonti\'deki eski bira fabrikasının dönüştürülmüş alanları yaratıcı konsept partiler için eşsiz bir atmosfer sunar. Harbiye Kongre Merkezi büyük ölçekli kurumsal aile günleri için tercih edilir. Teşvikiye ve Osmanbey\'deki butik mekanlar ise küçük grup organizasyonları için idealdir.',
    transportDetails: 'Şişli, İstanbul\'un en iyi toplu taşıma bağlantılarına sahip ilçesidir. M2 metro hattı Şişli-Mecidiyeköy, Osmanbey ve Gayrettepe duraklarıyla bölgenin merkezine ulaşım sağlar. Metrobüs Mecidiyeköy durağı şehrin her iki yakasından erişim imkanı verir. Taksim\'den Şişli\'ye minibüs ve otobüslerle 10 dakikada ulaşılabilir. Merkezi konumu sayesinde İstanbul\'un her noktasından kolay erişim avantajı vardır.',
    localCulture: 'Şişli, iş dünyası ve kültürel yaşamın iç içe olduğu kozmopolit bir ilçedir. Bomonti\'deki Babylon konser mekanı çevresinde gelişen sanat ve eğlence hayatı, Teşvikiye\'nin galeri ve tasarım dükkanları bölgenin yaratıcı enerjisini besler. Hafta sonları Feriköy Antika Pazarı aileler için kültürel bir gezi noktasıdır.',
    neighborhoodDetails: [
      { name: 'Mecidiyeköy', tip: 'Metrobüs bağlantısı ve iş merkezi yakınlığı', bestVenue: 'Trump Towers & Çevre Oteller' },
      { name: 'Bomonti', tip: 'Endüstriyel dönüşüm mekanları ve yaratıcı atmosfer', bestVenue: 'Bomonti Hilton & Ada Alanları' },
      { name: 'Teşvikiye', tip: 'Butik kafeler ve şık küçük mekanlar', bestVenue: 'Teşvikiye Butik Salonlar' },
      { name: 'Harbiye', tip: 'Büyük ölçekli kongre ve etkinlik merkezi', bestVenue: 'Harbiye Kongre Merkezi' },
      { name: 'Gayrettepe', tip: 'Otel salonları ve kurumsal etkinlik alanları', bestVenue: 'Marriott & Çevre Oteller' }
    ]
  },
  {
    slug: 'bakirkoy',
  ...
  },
  {
    ...
    venueGuide: 'Ataşehir\'de etkinlik mekanları modern ve çeşitlidir. Watergarden AVM çocuk etkinlik alanı ve açık hava restoran bölgesiyle doğum günleri için popülerdir. Palladium AVM kapalı oyun alanları ve parti salonlarına sahiptir. Finans merkezi çevresindeki oteller (Hilton, Doubletree) kurumsal aile günleri için profesyonel altyapı sunar. Küçükbakkalköy ve Barbaros mahallelerindeki büyük sitelerin sosyal tesisleri site içi organizasyonlar için en çok tercih edilen mekanlardır. Kayışdağı eteklerindeki piknik alanları açık hava etkinlikleri için doğal bir seçenektir.',
    transportDetails: 'Ataşehir\'e M4 Kadıköy-Tavşantepe metro hattının Yenisahra ve İçerenköy duraklarıyla ulaşılır. E-5 karayolu Küçükbakkalköy çıkışı ile araç erişimi kolaydır. Metrobüs Acıbadem durağından Ataşehir merkeze minibüslerle 15 dakikada ulaşılabilir. Finans merkezi bölgesinde ücretli otoparklar mevcuttur; hafta sonları AVM otoparkları ücretsizdir.',
    localCulture: 'Ataşehir, İstanbul\'un finans merkezi olarak iş dünyasının nabzını tutan bir ilçe olmasının yanında genç ailelerin yoğun olarak yaşadığı modern bir yerleşim alanıdır. Watergarden\'daki açık hava sinema geceleri, Brandium\'daki çocuk atölyeleri ve Barbaros Mahallesi\'ndeki komşuluk etkinlikleri bölgenin sosyal dokusunu oluşturur.',
    neighborhoodDetails: [
      { name: 'Küçükbakkalköy', tip: 'Büyük siteler ve sosyal tesis organizasyonları', bestVenue: 'Site Sosyal Tesisleri' },
      { name: 'Barbaros', tip: 'Finans merkezi yakınlığı ve lüks rezidanslar', bestVenue: 'Otel Etkinlik Salonları' },
      { name: 'İçerenköy', tip: 'Metro erişimli ve geniş park alanları', bestVenue: 'İçerenköy Parkı' },
      { name: 'Kayışdağı', tip: 'Doğa içi piknik ve açık hava etkinlikleri', bestVenue: 'Kayışdağı Piknik Alanları' }
    ]
  },
  {
    slug: 'uskudar',
    ...
    venueGuide: 'Üsküdar tarihi dokusu ve Boğaz manzarasıyla özel organizasyonlar için benzersiz mekanlar sunar. Çamlıca Tepesi\'ndeki restoranlar panoramik manzara eşliğinde etkinlikler düzenleme imkanı verir. Beylerbeyi\'ndeki tarihi yalılar ve konaklar özel davetler için kiralanabilir. Kuzguncuk ve Çengelköy\'ün bahçeli evleri samimi doğum günleri için ideal atmosfer sunar. Capitol AVM etkinlik alanı kapalı mekan partileri için uygun fiyatlı seçenektir. Fethi Paşa Korusu Boğaz manzaralı açık hava etkinlikleri için en gözde lokasyondur.',
    transportDetails: 'Üsküdar\'a Marmaray ile Sirkeci\'den 4 dakikada ulaşılır. M5 Üsküdar-Çekmeköy metro hattı Altunizade, Kısıklı ve Bulgurlu duraklarıyla ilçenin tepelerine erişim sağlar. İDO vapurları Üsküdar İskelesi\'ne düzenli sefer yapar. Çamlıca bölgesine toplu taşımayla ulaşım sınırlıdır; özel araç veya taksi tercih edilmelidir. Üsküdar sahilinde ücretsiz belediye otoparkı mevcuttur.',
    localCulture: 'Üsküdar, İstanbul\'un Anadolu Yakası\'nın tarihi ve kültürel merkezidir. Kuzguncuk\'un renkli evleri ve çiçekli sokakları fotoğraf çekimleri için İstanbul\'un en çok tercih edilen noktalarındandır. Çamlıca Camii çevresi Ramazan ayında aileler için özel etkinliklere ev sahipliği yapar. Çengelköy\'ün tarihi çınar ağacı altında düzenlenen mahalle etkinlikleri nostaljik bir atmosfer sunar.',
    neighborhoodDetails: [
      { name: 'Kuzguncuk', tip: 'Tarihi renkli evler ve samimi bahçeli mekanlar', bestVenue: 'Kuzguncuk Bahçeli Evler' },
      { name: 'Çengelköy', tip: 'Boğaz kıyısı çay bahçeleri ve konak mekanları', bestVenue: 'Çengelköy Tarihi Çay Bahçesi' },
      { name: 'Altunizade', tip: 'AVM etkinlik alanları ve modern tesisler', bestVenue: 'Capitol AVM' },
      { name: 'Beylerbeyi', tip: 'Tarihi yalılar ve saray bahçesi', bestVenue: 'Beylerbeyi Sarayı Çevresi' },
      { name: 'Çamlıca', tip: 'Panoramik Boğaz manzarası ve tepe restoranları', bestVenue: 'Çamlıca Tepesi Restoranları' }
    ]
  },
  {
    slug: 'maltepe',
    ...
    venueGuide: 'Maltepe\'nin en büyük avantajı İstanbul\'un en geniş sahil parkıdır. 5 km uzunluğundaki Maltepe Sahil Parkı açık hava doğum günleri, piknik organizasyonları ve çocuk festivalleri için sınırsız alan sunar. Parkın çocuk oyun alanları ve spor sahaları etkinliklere ek aktivite imkanı sağlar. Piazza AVM kış aylarında kapalı mekan partileri için etkinlik alanlarına sahiptir. İdealtepe sahil kesimindeki kafeler küçük grup organizasyonları için uygundur. Cevizli\'deki yeni konut sitelerinin sosyal tesisleri site içi doğum günleri için tercih edilmektedir.',
    transportDetails: 'Maltepe\'ye M4 Kadıköy-Tavşantepe metro hattının Cevizli ve Maltepe duraklarıyla ulaşılır. Marmaray Cevizli durağı da alternatif bir ulaşım seçeneğidir. E-5 karayolu sahil boyunca uzanır. Sahil parkına metro istasyonundan yürüyerek 10 dakikada ulaşılabilir. Hafta sonları sahil parkı otoparkında yer bulmak zor olabilir; toplu taşıma önerilir.',
    localCulture: 'Maltepe, İstanbul\'un dolgu alanı üzerinde oluşturulan sahil parkıyla şehrin en büyük açık hava etkinlik alanına sahip olmuştur. Yaz aylarında sahil parkında belediye tarafından düzenlenen çocuk festivalleri, açık hava sinema geceleri ve spor etkinlikleri binlerce aileyi bir araya getirmektedir. Bağlarbaşı bölgesinde haftada bir kurulan organik pazar aileler için popüler bir buluşma noktasıdır.',
    neighborhoodDetails: [
      { name: 'Cevizli', tip: 'Metro erişimli modern siteler ve AVM yakınlığı', bestVenue: 'Piazza AVM & Site Sosyal Tesisleri' },
      { name: 'İdealtepe', tip: 'Sahil kafeler ve deniz manzaralı mekanlar', bestVenue: 'İdealtepe Sahil Kafeleri' },
      { name: 'Altıntepe', tip: 'Sakin konut bölgesi ve bahçeli mekanlar', bestVenue: 'Altıntepe Parkları' },
      { name: 'Bağlarbaşı', tip: 'Tepe manzarası ve organik pazar çevresi', bestVenue: 'Bağlarbaşı Sosyal Alanları' }
    ]
  },
  {
    slug: 'kartal',
    ...
    venueGuide: 'Kartal kentsel dönüşümle birlikte modern etkinlik mekanlarıyla zenginleşmiştir. Dragos Tepesi restoranları Adalar ve deniz manzarası eşliğinde etkinlik düzenleme imkanı sunar. Kordonboyu sahil şeridi boyunca kafeler ve restoranlar küçük grup partileri için uygundur. Via Port AVM geniş etkinlik alanları ve çocuk eğlence merkezi ile kapalı mekan organizasyonlarına ev sahipliği yapar. Soğanlık\'taki yeni sitelerin sosyal tesisleri ve Yakacık\'ın bahçeli evleri alternatif mekan seçenekleri sunar.',
    transportDetails: 'Kartal\'a M4 metro hattının Kartal ve Yakacık duraklarıyla ulaşılır. Marmaray Kartal durağı sahil bölgesine doğrudan erişim sağlar. E-5 karayolu Kartal çıkışı araç erişimi için kullanılır. Sahil boyunca belediye otoparkları mevcuttur. Dragos Tepesi\'ne ulaşım için özel araç gereklidir; toplu taşıma seçenekleri sınırlıdır.',
    localCulture: 'Kartal, kentsel dönüşümün en hızlı yaşandığı İstanbul ilçelerinden biridir. Kordonboyu sahil bandının yenilenmesiyle bölge açık hava etkinliklerinin merkezi haline gelmiştir. Yaz aylarında Kartal Sahili\'nde belediye tarafından düzenlenen çocuk tiyatroları ve festivaller ailelerin buluşma noktasıdır. Dragos\'un doğal güzelliği doğa yürüyüşleri ve piknik organizasyonları için ideal bir zemin oluşturur.',
    neighborhoodDetails: [
      { name: 'Kordonboyu', tip: 'Yenilenmiş sahil şeridi ve deniz manzaralı mekanlar', bestVenue: 'Kordonboyu Sahil Restoranları' },
      { name: 'Soğanlık', tip: 'Modern siteler ve geniş sosyal tesisler', bestVenue: 'Soğanlık Site Sosyal Tesisleri' },
      { name: 'Yakacık', tip: 'Metro erişimli ve uygun fiyatlı mekanlar', bestVenue: 'Yakacık Parkları & Kafeleri' },
      { name: 'Dragos', tip: 'Panoramik manzara ve doğa içi etkinlikler', bestVenue: 'Dragos Tepesi Restoranları' }
    ]
  },
  {
    slug: 'pendik',
  ...
  },
  {
    ...
    venueGuide: 'Beylikdüzü modern site yaşamıyla çocuk etkinlikleri için pratik mekanlar sunar. Yaşam Vadisi ve Valley Parkı büyük çim alanları ve oyun parkalarıyla açık hava partileri için idealdir. Migros AVM etkinlik alanı ve çocuk eğlence merkezi kış partileri için popülerdir. Tüyap Fuar Merkezi büyük ölçekli kurumsal etkinlikler ve festivaller için uygun altyapıya sahiptir. Beylikdüzü Marina deniz kenarı organizasyonlar için şık bir alternatif sunar. Büyükşehir ve Yakuplu mahallelerindeki sitelerin çoğu geniş sosyal tesislere sahiptir.',
    transportDetails: 'Beylikdüzü\'ne metrobüs Beylikdüzü Son Durak ve Kavakli duraklarıyla ulaşılır. E-5 karayolu doğrudan bağlantı sağlar. İlçe içi ulaşım minibüslerle sağlanır. Metrobüs duraklarından site bölgelerine 10-15 dakika yürüme mesafesi vardır. AVM ve marina bölgelerinde geniş ücretsiz otoparklar mevcuttur.',
    localCulture: 'Beylikdüzü, İstanbul\'un genç ve dinamik aile nüfusunun yoğunlaştığı bir ilçedir. Yaşam Vadisi\'ndeki hafta sonu aktiviteleri, marina çevresindeki açık hava etkinlikleri ve site bahçelerindeki komşuluk buluşmaları bölgenin topluluk ruhunu yansıtır. Tüyap Fuar Merkezi\'ndeki kitap fuarı ve çocuk festivalleri yılın öne çıkan kültürel etkinlikleridir.',
    neighborhoodDetails: [
      { name: 'Yakuplu', tip: 'Geniş siteler ve sosyal tesis organizasyonları', bestVenue: 'Yakuplu Site Sosyal Tesisleri' },
      { name: 'Büyükşehir', tip: 'Modern rezidanslar ve bahçe partisi imkanları', bestVenue: 'Büyükşehir Siteler Bölgesi' },
      { name: 'Kavakli', tip: 'Metrobüs erişimli ve AVM yakınlığı', bestVenue: 'Migros AVM & Çevre Mekanları' },
      { name: 'Adnan Kahveci', tip: 'Marina yakınlığı ve deniz manzarası', bestVenue: 'Beylikdüzü Marina Restoranları' }
    ]
  },
  {
    slug: 'sariyer',
    ...
    venueGuide: 'Sarıyer, İstanbul\'un en yeşil ve doğa ile iç içe etkinlik mekanlarına ev sahipliği yapar. Emirgan Korusu lale sezonu ve sonbahar renkleri ile fotoğraf çekimleri dahil her mevsim etkinliklere uygun geniş alanlar sunar. Belgrad Ormanı girişindeki piknik alanları büyük gruplar için doğa partileri düzenlemeye idealdir. İstinye Park AVM lüks etkinlik alanları ve çocuk aktivite merkezleriyle kapalı mekan organizasyonları sunar. Tarabya sahilindeki oteller ve restoranlar Boğaz manzaralı partiler için tercih edilir. Zekeriyaköy villa bahçeleri havuzlu partiler ve bahçe organizasyonları için en çok tercih edilen mekanlardır.',
    transportDetails: 'Sarıyer\'e sahil yolundan (Sariyer Caddesi) ve TEM bağlantı yolundan ulaşılır. 25E ve 40 numaralı otobüsler Taksim\'den Sarıyer\'e düzenli sefer yapar. İstinye bölgesine İstinye Park AVM servis otobüsleri çeşitli noktalardan kalkar. Zekeriyaköy ve Bahçeköy\'e TEM Kilyos sapağından ulaşılır; toplu taşıma seçenekleri sınırlıdır. Emirgan Korusu\'nun otoparkı hafta sonları hızla dolar; erken gitmeniz veya toplu taşıma kullanmanız önerilir.',
    localCulture: 'Sarıyer, İstanbul\'un doğa ve kültür haritasının en zengin noktalarından biridir. Emirgan Korusu\'nun lale festivali her yıl yüz binlerce ziyaretçi çeker. Rumelihisarı\'nın tarihi duvarları açık hava konserleri ve kültürel etkinliklere ev sahipliği yapar. Bahçeköy\'ün organik çiftlikleri çocuklar için doğa ve tarım atölyeleri düzenlemektedir.',
    neighborhoodDetails: [
      { name: 'Emirgan', tip: 'Tarihi koruluk, lale festivali ve geniş yeşil alanlar', bestVenue: 'Emirgan Korusu' },
      { name: 'İstinye', tip: 'Lüks AVM ve kapalı mekan etkinlikleri', bestVenue: 'İstinye Park AVM' },
      { name: 'Tarabya', tip: 'Boğaz kıyısı oteller ve deniz manzaralı mekanlar', bestVenue: 'Grand Tarabya & Sahil Restoranları' },
      { name: 'Zekeriyaköy', tip: 'Villa bahçeleri ve havuzlu özel organizasyonlar', bestVenue: 'Zekeriyaköy Villa Bahçeleri' },
      { name: 'Bahçeköy', tip: 'Orman girişi piknik alanları ve çiftlik etkinlikleri', bestVenue: 'Belgrad Ormanı Piknik Alanları' }
    ]
  },
  {
    slug: 'fatih',
  ...
  },
  {
    ...
    venueGuide: 'Başakşehir aile odaklı yaşam alanlarıyla çocuk etkinlikleri için zengin seçenekler sunar. Bahçeşehir Gölet çevresi açık hava partileri ve piknikler için İstanbul\'un batı yakasının en popüler toplanma noktasıdır. Başakşehir Millet Bahçesi geniş çim alanları, oyun parkları ve spor tesisleriyle büyük ölçekli çocuk festivalleri düzenlemeye uygundur. Bahçeşehir 1. ve 2. kısımlardaki sitelerin sosyal tesisleri kapalı ve açık mekan organizasyonları için profesyonel altyapıya sahiptir. Kayabaşı\'nın mega siteleri toplu etkinlikler ve site şenlikleri için İstanbul\'un en yoğun talep gören bölgesidir.',
    transportDetails: 'Başakşehir\'e metrobüs Bahçeşehir duraklarıyla ulaşılır. TEM otoyolu Bahçeşehir ve Kayabaşı çıkışları araç erişimi sağlar. İlçe içi ulaşım belediye otobüsleri ve minibüslerle sağlanır. Bahçeşehir Gölet çevresinde ücretsiz otoparklar mevcuttur. Kayabaşı bölgesi TEM\'den biraz içeridedir; servis araçları ve özel araç kullanımı daha pratiktir.',
    localCulture: 'Başakşehir, İstanbul\'un en hızlı büyüyen ve genç aile nüfusunun yoğunlaştığı ilçelerindendir. Bahçeşehir gölet çevresi her mevsim aileler için buluşma noktasıdır; yürüyüş yolları, bisiklet parkurları ve çocuk parkları aktif bir yaşam sunar. Millet Bahçesi\'ndeki kültürel etkinlikler, sergi alanları ve açık hava konser alanı bölgenin sosyal hayatını zenginleştirir.',
    neighborhoodDetails: [
      { name: 'Bahçeşehir', tip: 'Gölet çevresi açık hava etkinlikleri ve site sosyal tesisleri', bestVenue: 'Bahçeşehir Gölet & Çevre Parkları' },
      { name: 'Kayabaşı', tip: 'Mega siteler ve toplu organizasyonlar için geniş alanlar', bestVenue: 'Kayabaşı Site Sosyal Tesisleri' },
      { name: 'Altınşehir', tip: 'Millet Bahçesi yakınlığı ve park alanları', bestVenue: 'Başakşehir Millet Bahçesi' },
      { name: 'İkitelli', tip: 'Sanayi bölgesi dönüşümü ve etkinlik salonları', bestVenue: 'İkitelli Etkinlik Mekanları' }
    ]
  },
  {
    slug: 'kucukcekmece',
...
export const services = [
  ...
  },
  {
    ...
    image: '/content/images/profesyonelmakeup/profesyonelyuzboyamasianafoto.webp'
  },
  {
