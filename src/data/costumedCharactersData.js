// Kostümlü Karakterler Verisi
// Kategorize: Kız Çocuk, Erkek Çocuk, Her İkisi

export const costumedCharactersData = {
  girlsCharacters: [
    {
      id: 'elsa',
      name: 'Elsa',
      ...
      textSide: 'right',
      slug: 'elsa-kiralama-istanbul',
      category: 'girls',
      age: 'Kız Çocuk',
      features: [
        'Orijinal Frozen kostümü',
        'Let It Go şarkısı performansı',
        'Kardan adam Olaf ile hikaye',
        'Fotoğraf çekimi',
        'Dans gösterisi'
      ]
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'pamuk-prenses-kiralama-istanbul',
      category: 'girls',
      age: 'Kız Çocuk',
      features: [
        'Orijinal Pamuk Prenses kostümü',
        'Masal anlatımı',
        'Prenses dansı',
        'Fotoğraf çekimi',
        'Şarkı performansı'
    ...
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'right',
      slug: 'minnie-mouse-kiralama-istanbul',
      category: 'girls',
      age: 'Kız Çocuk',
      features: [
        'Orijinal Disney kostümü',
        'Sevimli dans gösterileri',
        'Çocuklarla etkileşim',
        'Fotoğraf çekimi',
        'Mickey Mouse ile ikili performans opsiyonu'
      ]
    },
    {
      id: 'deniz-kizi',
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'deniz-kizi-kiralama-istanbul',
      category: 'girls',
      age: 'Kız Çocuk',
      features: [
        'Muhteşem deniz kızı kostümü',
        'Sualtı masal anlatımı',
        'Dans performansı',
        'Fotoğraf çekimi',
        'Okyanus temalı şarkılar'
      ]
    },
    {
      id: 'unicorn',
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'right',
      slug: 'unicorn-kiralama-istanbul',
      category: 'girls',
      age: 'Kız Çocuk',
      features: [
        'Renkli unicorn kostümü',
        'Sihirli dans gösterisi',
        'Masal anlatımı',
        'Fotoğraf çekimi',
        'Çocuklarla etkileşimli oyunlar'
      ]
    }
  ],
  ...
  boysCharacters: [
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'spiderman-kiralama-istanbul',
      category: 'boys',
      age: 'Erkek Çocuk',
      features: [
        'Orijinal Marvel kostümü',
        'Örümcek ağı atma gösterisi',
        'Akrobatik hareketler',
        'Fotoğraf çekimi',
        'Süper kahraman eğitimi'
      ]
    },
    {
      id: 'batman',
    ...
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'paw-patrol-kiralama-istanbul',
      category: 'boys',
      age: 'Erkek Çocuk',
      features: [
        'Chase, Marshall ve diğer karakterler',
        'Kurtarma görevleri',
        'Eğlenceli oyunlar',
        'Fotoğraf çekimi',
        'Takım çalışması aktiviteleri'
      ]
    }
  ],
  ...
  unisexCharacters: [
    ...
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'mickey-mouse-kiralama-istanbul',
      category: 'unisex',
      age: 'Her İkisi',
      features: [
        'Orijinal Disney kostümü',
        'Eğlenceli dans gösterileri',
        'Mickey Mouse şarkıları',
        'Fotoğraf çekimi',
        'Minnie Mouse ile ikili performans'
      ]
    },
    {
      id: 'masa-koca-ayi',
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'right',
      slug: 'masa-koca-ayi-kiralama-istanbul',
      category: 'unisex',
      age: 'Her İkisi',
      features: [
        'Maşa ve Ayı kostümleri',
        'Eğlenceli oyunlar',
        'Çizgi film şarkıları',
        'Fotoğraf çekimi',
        'Çocuklarla etkileşim'
      ]
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'pikachu-kiralama-istanbul',
      category: 'unisex',
      age: 'Her İkisi',
      features: [
        'Orijinal Pikachu kostümü',
        'Pokemon şarkıları',
        'Enerji dolu dans gösterisi',
        'Fotoğraf çekimi',
        'Pokemon oyunları'
      ]
    },
    {
      ...
      borderColor: 'rgba(255, 255, 255, 0.3)',
      textSide: 'left',
      slug: 'noel-baba-kiralama-istanbul',
      category: 'unisex',
      age: 'Her İkisi',
      features: [
        'Gerçek Noel Baba kostümü',
        'Hediye dağıtımı',
        'Noel şarkıları',
        'Fotoğraf çekimi',
        'Noel hikayesi anlatımı'
      ]
    }
  ]
}

// Tüm karakterleri tek array olarak
export const allCostumedCharacters = [
  ...costumedCharactersData.girlsCharacters,
  ...costumedCharactersData.boysCharacters,
  ...costumedCharactersData.unisexCharacters
]

// Karakteri slug ile bul
export const getCharacterBySlug = (slug) => {
  return allCostumedCharacters.find(char => char.slug === slug)
}
