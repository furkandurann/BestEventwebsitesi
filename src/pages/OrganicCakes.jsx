    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-pink-50 to-purple-50 py-20 md:py-32">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 bg-[url('/content/images/konseptpasta/635ab479-32b7-4c72-8873-b304296dada1.webp')] opacity-5 bg-cover bg-center"></div>
        </div>
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden bg-gray-100">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = '/content/images/konseptpasta/0219E907-22DD-4A54-AA25-355009477BA1.webp'
                    }}
                  />
