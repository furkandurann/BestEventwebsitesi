...
const Gallery = () => {
  ...
  const galleryImages = {
    karakterler: [
      { src: '/content/images/Kostumlukarakterler/elsa.JPG', category: 'Kostümlü Karakterler', alt: 'Elsa Karakter Kiralama İstanbul' },
      { src: '/content/images/Kostumlukarakterler/elsaheroo.JPG', category: 'Kostümlü Karakterler', alt: 'Elsa Frozen İstanbul' },
      { src: '/content/images/Kostumlukarakterler/pamukprensesyenii.JPG', category: 'Kostümlü Karakterler', alt: 'Pamuk Prenses Kiralama' },
      { src: '/content/images/Kostumlukarakterler/pamukprensesyeniii.JPG', category: 'Kostümlü Karakterler', alt: 'Pamuk Prenses İstanbul' },
      { src: '/content/images/Kostumlukarakterler/batman.jpg', category: 'Kostümlü Karakterler', alt: 'Batman Kiralama İstanbul' },
      { src: '/content/images/Kostumlukarakterler/spidermancosku.JPG', category: 'Kostümlü Karakterler', alt: 'Spiderman Karakter' },
      { src: '/content/images/Kostumlukarakterler/spidermann.JPG', category: 'Kostümlü Karakterler', alt: 'Spiderman İstanbul' },
      { src: '/content/images/Kostumlukarakterler/minniemause.JPG', category: 'Kostümlü Karakterler', alt: 'Minnie Mouse Kiralama' },
      { src: '/content/images/Kostumlukarakterler/minnieyenii.jpg', category: 'Kostümlü Karakterler', alt: 'Minnie Mouse İstanbul' },
      { src: '/content/images/Kostumlukarakterler/mickeyyeni.jpg', category: 'Kostümlü Karakterler', alt: 'Mickey Mouse Kiralama' },
      { src: '/content/images/Kostumlukarakterler/palyaco.JPG', category: 'Kostümlü Karakterler', alt: 'Palyaço İstanbul' },
      { src: '/content/images/Kostumlukarakterler/masakocaayi.jpg', category: 'Kostümlü Karakterler', alt: 'Maşa Koca Ayı Kiralama' },
      { src: '/content/images/Kostumlukarakterler/unicornyeniii.jpg', category: 'Kostümlü Karakterler', alt: 'Unicorn Karakter İstanbul' },
    ],
    bubbleshow: [
      { src: '/content/images/bubbleshow/anabubble.JPG', category: 'Bubble Show', alt: 'Bubble Show İstanbul' },
      { src: '/content/images/bubbleshow/anabubblee.JPG', category: 'Bubble Show', alt: 'Sabun Köpüğü Gösterisi' },
      { src: '/content/images/bubbleshow/anabubbleee.JPG', category: 'Bubble Show', alt: 'Bubble Show Organizasyonu' },
      { src: '/content/images/bubbleshow/bubbleshowhero.JPG', category: 'Bubble Show', alt: 'Profesyonel Bubble Show' },
      { src: '/content/images/bubbleshow/bubbleshownattive.jpeg', category: 'Bubble Show', alt: 'Bubble Show Kiralama' },
      { src: '/content/images/bubbleshow/bubbleshowslider.jpeg', category: 'Bubble Show', alt: 'İstanbul Bubble Show' },
      { src: '/content/images/bubbleshow/bubbleshowslider2.jpeg', category: 'Bubble Show', alt: 'Çocuk Bubble Show' },
      { src: '/content/images/bubbleshow/bubbleshowslider3.jpeg', category: 'Bubble Show', alt: 'Doğum Günü Bubble Show' },
      { src: '/content/images/bubbleshow/IMG_1748.JPG', category: 'Bubble Show', alt: 'Bubble Show Gösterisi' },
      { src: '/content/images/bubbleshow/IMG_1797.JPG', category: 'Bubble Show', alt: 'Bubble Sanatçısı İstanbul' },
    ],
    kurumsal: [
      { src: '/content/images/Anasayfa/kocholdingkurumsal.jpg', category: 'Kurumsal Etkinlikler', alt: 'Koç Holding Etkinlik' },
      { src: '/content/images/Anasayfa/vodafonekurumsal.jpeg', category: 'Kurumsal Etkinlikler', alt: 'Vodafone Organizasyon' },
      { src: '/content/images/acilisorganizasyonu/IMG_0198.JPG', category: 'Kurumsal Etkinlikler', alt: 'Açılış Organizasyonu İstanbul' },
      { src: '/content/images/acilisorganizasyonu/IMG_1379.JPG', category: 'Kurumsal Etkinlikler', alt: 'Mağaza Açılışı' },
      { src: '/content/images/acilisorganizasyonu/IMG_1380.JPG', category: 'Kurumsal Etkinlikler', alt: 'Şube Açılışı' },
      { src: '/content/images/acilisorganizasyonu/IMG_1382.JPG', category: 'Kurumsal Etkinlikler', alt: 'Ofis Açılışı' },
      { src: '/content/images/acilisorganizasyonu/IMG_1388.JPG', category: 'Kurumsal Etkinlikler', alt: 'Kurumsal Parti' },
      { src: '/content/images/acilisorganizasyonu/IMG_1695.JPG', category: 'Kurumsal Etkinlikler', alt: 'Şirket Etkinliği' },
      { src: '/content/images/acilisorganizasyonu/IMG_1723.JPG', category: 'Kurumsal Etkinlikler', alt: 'Yılbaşı Partisi' },
      { src: '/content/images/acilisorganizasyonu/IMG_1748.JPG', category: 'Kurumsal Etkinlikler', alt: '23 Nisan Etkinliği' },
      { src: '/content/images/acilisorganizasyonu/IMG_1757.JPG', category: 'Kurumsal Etkinlikler', alt: 'Çocuk Şenliği' },
    ],
    dans: [
      { src: '/content/images/Anasayfa/balletdans.jpg', category: 'Dans Etkinlikleri', alt: 'Balet Gösterisi İstanbul' },
      { src: '/content/images/Anasayfa/dansanasayfa2.jpeg', category: 'Dans Etkinlikleri', alt: 'Dans Gösterisi' },
      { src: '/content/images/Anasayfa/dansanasayfaanagorsel.JPG', category: 'Dans Etkinlikleri', alt: 'Profesyonel Dans' },
      { src: '/content/images/Anasayfa/dansgirl.jpeg', category: 'Dans Etkinlikleri', alt: 'Dans Ekibi İstanbul' },
    ],
    parti: [
    ...
    teknoloji: [
      { src: '/content/images/bidolu/transformers.jpeg', category: 'Teknoloji', alt: 'Transformers Robot Kiralama' },
      { src: '/content/images/bidolu/gezegentanıtım.jpeg', category: 'Teknoloji', alt: 'Gezegen Tanıtım Etkinliği' },
      { src: '/content/images/bidolu/karaoke.jpg', category: 'Teknoloji', alt: 'Karaoke Etkinliği İstanbul' },
    ...
    dogumgunu: [
      { src: '/content/images/cocukdogumgunu/3cc6171f-7a84-42ce-9592-b7cdeda4a0a8.jpg', category: 'Doğum Günü', alt: 'Doğum Günü Organizasyonu' },
      { src: '/content/images/cocukdogumgunu/4cfdb70b-f05f-41f0-b8d0-99d3a29c8593.JPG', category: 'Doğum Günü', alt: 'Çocuk Doğum Günü' },
      { src: '/content/images/cocukdogumgunu/082041d3-58ff-4b19-81e0-5a6e39d81532.jpg', category: 'Doğum Günü', alt: 'Parti Organizasyonu' },
      { src: '/content/images/cocukdogumgunu/14445323-1fe3-4dea-8055-831975e83963.JPG', category: 'Doğum Günü', alt: 'Konsept Doğum Günü' },
      { src: '/content/images/cocukdogumgunu/21380558-d41b-42eb-8885-5588f0b8931f.JPG', category: 'Doğum Günü', alt: 'Doğum Günü Partisi' },
      { src: '/content/images/IMG_9586.PNG', category: 'Doğum Günü', alt: 'Doğum Günü İstanbul' },
      { src: '/content/images/IMG_9587.PNG', category: 'Doğum Günü', alt: 'Parti Süsleme' },
      { src: '/content/images/IMG_9588.PNG', category: 'Doğum Günü', alt: 'Doğum Günü Kutlaması' },
      { src: '/content/images/IMG_9589.PNG', category: 'Doğum Günü', alt: 'Çocuk Partisi' },
    ],
  }
